...
![Daughterboard Pin Jumpers](../media/photos/lte/LTE_JumperOriginal.png)
...
![Daughterboard Pin Jumpers Changed](../media/photos/lte/LTE_JumperChanged.png)
...
![Daughterboard USB Connector](../media/photos/lte/LTE_USBMainboard.png)

You can then proceed to removing the USB hub board altogether:

![USB Hub Removed](../media/photos/lte/LTE_HubRemoved.png)
