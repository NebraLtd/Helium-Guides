...
!> * **<span style="color:red">Never power on the Indoor hotspot without it's antenna connected as this may damage the unit.</span>** <br>Do not place in direct sunlight or on hot surfaces (e.g a Heater).<br> * The Indoor unit's case is designed to be used indoors, and is not suitable for use outside.
